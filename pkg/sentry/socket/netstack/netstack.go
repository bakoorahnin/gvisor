...
var Metrics = tcpip.Stats{
	...
	IP: tcpip.IPStats{
		...
		UnrouteablePacketsDropped:                 mustCreateMetric("/netstack/ip/unrouteable_packets_dropped", "Number of IP packets received which couldn't be routed and thus were not forwarded."),
		PacketsDroppedDueToExhaustedTTL:           mustCreateMetric("/netstack/ip/packets_dropped_due_to_exhausted_ttl", "Number of IP packets received which could not be forwarded due to an exhausted TTL."),
		PacketsDroppedDueToLinkLocalSourceAddress: mustCreateMetric("/netstack/ip/packets_dropped_due_to_link_local_source_address", "Number of IP packets received which could not be forwarded due to a link-local source address."),
		PacketsDroppedDueToLinkLocalDestAddress:   mustCreateMetric("/netstack/ip/packets_dropped_due_to_link_local_dest_address", "Number of IP packets received which could not be forwarded due to a link-local destination address."),
		PacketsDroppedDueToExtensionHeaderProblem: mustCreateMetric("/netstack/ip/packets_dropped_due_to_extension_header_problem", "Number of IP packets received which could not be forwarded due to a problem processing their IPv6 extension headers."),
		PacketForwardingErrors:                    mustCreateMetric("/netstack/ip/packet_forwarding_errors", "Number of IP packets which couldn't be forwarded."),
