...
// Package quotedev implements a vfs.Device for /dev/quote.
package quotedev
...
// quoteDevice implements vfs.Device for /dev/quote
//
// +stateify savable
...
func CreateDevtmpfsFiles(ctx context.Context, dev *devtmpfs.Accessor) error {
	return dev.CreateDeviceFile(ctx, "quote", vfs.CharDevice, linux.UNNAMED_MAJOR, quoteDevMinor, 0666 /* mode */)
}
